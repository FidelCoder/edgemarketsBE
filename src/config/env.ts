...
export const env = {
  ...
  agentWorkerEnabled: parseBoolean(process.env.AGENT_WORKER_ENABLED, false),
  agentWorkerIntervalMs: toPositiveInt(process.env.AGENT_WORKER_INTERVAL_MS, 20000),
  agentWorkerBatchSize: toPositiveInt(process.env.AGENT_WORKER_BATCH_SIZE, 20),
